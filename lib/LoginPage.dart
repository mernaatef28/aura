            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.email, color: AppColors.lightYellow),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Password',
                  labelStyle: TextStyle(color: AppColors.lightYellow),
                  prefixIcon: Icon(Icons.lock, color: AppColors.lightYellow),
                  border: InputBorder.none, // No box border
                  focusedBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: AppColors.lightYellow),
                  ),
                ),
              ...
              TextButton(
                ...
                child: Text(
                  'Forgot password?',
                  style: TextStyle(color: AppColors.lightYellow), // Darker yellow text
                ),
              ),
              SizedBox(height: 15),
